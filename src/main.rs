...
struct Resources<B: gfx_hal::Backend> {
    ...
    surface: B::Surface,
    device: B::Device,
    // TODO: Vec here is a hack: refactor it to not use template types, remove Vec
...
// TODO: I don't even know this syntax? a struct that is a Trait ManuallyDrop for Resources<B>? idk.
//       figure out what this means or replace code.
            ...
            Event::RedrawRequested(_) => {
                ...
                let surface_image = unsafe {
                    ...
                    match res.surface.acquire_image(acquire_timeout_ns) {
                        Ok((image, _)) => image,
                        Err(_) => {
                            // TODO: seems like a bad way of handling this error?
                            should_configure_swapchain = true;
                            return;
                        }
                    }
                ...
                let framebuffer = unsafe {
                    ...
                    // TODO: allocating a vector each frame .. fix 
                    res.device
                        .create_framebuffer(
                            render_pass,
                ...
                // This should only change on resize?
                let viewport = {
